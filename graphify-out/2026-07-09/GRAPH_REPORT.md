...
## Corpus Check
- 166 files · ~68,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 861 edges · 55 communities (47 shown, 8 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 157 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba1812af`
...
- `Auth()` --calls--> `cn()`  [INFERRED]
  src/pages/Auth.tsx → src/lib/utils.ts
...
Cohesion: 0.08
Nodes (18): useBankFormats(), useUpsertBankFormat(), deleteCommunityVote(), ruleCommunityKey(), RuleLike, syncCommunityVoteOnEdit(), upsertCommunityVote(), useCommunityRuleMap() (+10 more)
...
Cohesion: 0.06
Nodes (41): ACCOUNT_SECTIONS, ACCOUNT_TYPE_META, AccountFilter, AccountSection, FILTER_TYPES, applyKeywordRules(), matches(), ALWAYS_RULES (+33 more)
...
Cohesion: 0.10
Nodes (25): CategoryCombobox(), CategoryComboboxProps, normalize(), ProfileContext, ProfileContextValue, useProfile(), useCategories(), useCategoryGroups() (+17 more)

### Community 6 - "useImport.ts"
Cohesion: 0.09
Nodes (29): DATE_PARSE_FORMATS, ensureOpeningBalance(), fetchAllAccountMovements(), ManualBalance, normalizeTime(), parseAmount(), ParsedRow, reconcileProfileTransfers() (+21 more)
...
Cohesion: 0.12
Nodes (18): AccountCard(), AccountCardProps, deriveOpeningIfMissing(), fetchAccountMovementsChrono(), ImportBatchRow, invalidateAfterBatchChange(), nullOpeningIfEmpty(), useDeleteBatch() (+10 more)
...
### Community 14 - "cn"
Cohesion: 0.06
Nodes (34): Badge(), BadgeProps, badgeVariants, DatePickerField(), DatePickerFieldProps, DialogContent(), DialogDescription(), DialogFooter() (+26 more)

### Community 15 - "automap.ts"
Cohesion: 0.12
Nodes (20): CategoryInput, deleteTranslations(), GroupInput, invalidateAll(), Labels, upsertTranslations(), useDeleteCategory(), useDeleteCategoryGroup() (+12 more)
...
## Knowledge Gaps
- **265 isolated node(s):** `root`, `$schema`, `UserPromptSubmit`, `name`, `private` (+260 more)
...
- **Why does `cn()` connect `cn` to `Sidebar.tsx`, `Dashboard`, `AccountForm.tsx`, `History`, `geo.ts`, `dropdown-menu.tsx`, `PasswordStrengthBar`, `Auth.tsx`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `useProfile()` connect `Dashboard` to `Transactions`, `Sidebar.tsx`, `Home.tsx`, `useTransactions.ts`, `AccountForm.tsx`, `History`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `Transactions()` connect `Dashboard` to `database.types.ts`, `Home.tsx`, `useTransactions.ts`, `AccountForm.tsx`, `History`?**
