-- ============================================================
-- FinTrack — Rollback de la migración 038
-- Ejecutar en el SQL Editor de Supabase para revertir 038_merchant_pattern_wildcard.sql
-- ============================================================
--
-- Restaura admin_link_merchant_transactions a la versión de la migración 037
-- (sin soporte de comodín *, siempre palabra/frase completa).
