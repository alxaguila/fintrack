-- ============================================================
-- FinTrack — Migración 046: cuentas archivadas no cuentan en el plan
-- ============================================================
--
-- get_plan_usage() contaba TODAS las cuentas del usuario (incluidas las
-- archivadas, is_active = false), penalizando el límite del plan aunque esas
-- cuentas ya estén ocultas en el resto de la app (useAccounts.ts filtra
-- is_active = true en todas las pantallas). Se añade el mismo filtro aquí
-- para que "Cuentas conectadas" en Mi plan refleje solo cuentas activas.
-- ------------------------------------------------------------
